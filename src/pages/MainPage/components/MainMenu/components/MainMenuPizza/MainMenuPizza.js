...
import styles from "./MainMenuPizza.module.css";
    ...
    return (
        <div className={styles.secondPageTopPizza}>
            ...
            <div className={styles.secondPagePizzaElse}>
                {isVisibleBtn && <button className={styles.secondPagePizzaElseBtn} onClick={getElse}>Показать
                    еще</button>}
            </div>
            <div className={styles.secondPageTopPizzaWrapper}>
                {isVisible && newPizza}

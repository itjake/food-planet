    ...
    return (<>
            ...
            <div className={styles.adminPageMid}>
                <ul className={styles.adminPageMidItems}>
                    ...
                    <li>
                        <NavLink to="/admin/check-order" className={setActive}>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                    ...
                    <li>
                        <NavLink to="/admin/check-menu" className={setActive}>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <NavLink to="/admin/check-contacts" className={setActive}>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                    ...
                    <li>
                        <NavLink to="/admin/check-review" className={setActive}>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
                    ...
                    <li>
                        <NavLink to="/admin/check-employees" className={setActive}>
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4"
